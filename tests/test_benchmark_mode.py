...
class BenchmarkModeTest(unittest.TestCase):
    ...
    def test_adapter_enforces_q_a_channel_ownership(self):
        ...
        self.assertEqual(q_permission["read"]["ch/q.md"], "allow")
        self.assertEqual(q_permission["read"]["ch/k.md"], "allow")
        self.assertEqual(q_permission["read"]["ch/metadata.json"], "allow")
